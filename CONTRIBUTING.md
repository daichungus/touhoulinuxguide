...
## Issues
- Before opening a new issue, check if it has already been posted before, either here or elsewhere online.
- When describing your issue, be sure to carefully list the order of events that happened before the issue.
- If the issue arose while you were following this guide, state which section of the guide you were following when the issue happened.
- It's helpful to the maintainers that you specify what Linux distribution and hardware you encountered your issue on.
- If the issue is grammatical or related to wording, please create a pull request if possible.
